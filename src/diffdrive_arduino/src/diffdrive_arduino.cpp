  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  // Affichage des positions et vitesses calculées
  //RCLCPP_INFO(logger_, "Position - Left: %f, Right: %f", l_wheel_.pos, r_wheel_.pos);
  //RCLCPP_INFO(logger_, "Velocity - Left: %f, Right: %f", l_wheel_.vel, r_wheel_.vel);

  // RCLCPP_INFO(logger_, " %f, %f,- %f, %f", l_wheel_.pos, r_wheel_.pos, l_wheel_.vel, r_wheel_.vel);
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  double left_cmd = l_wheel_.cmd / l_wheel_.rads_per_count / cfg_.loop_rate;
  double right_cmd = r_wheel_.cmd / r_wheel_.rads_per_count / cfg_.loop_rate;

  arduino_.setMotorValues(left_cmd, right_cmd);

  // Affichage des commandes envoyées
  //RCLCPP_INFO(logger_, "C: %f, %f", left_cmd, right_cmd);
